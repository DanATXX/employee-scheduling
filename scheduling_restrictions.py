...
def build_cqm():
    ...
    # TODO: Set constraints to reflect the restrictions in the README.,{employee},{shift}")
    for i in range(num_shifts):
        ...
        cqm.add_constraint_from_iterable( [(f"x_{j}_{i}",1) for j in preferences],"==", 2 )
